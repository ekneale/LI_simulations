...
void compare_locs_and_times_refl_col(char const *filename, char const *filename2){
	...
	int n=10;
	int n1 = t1->Draw("chi2:refl:err_chi2","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector<double> xerrors(n,0);
    TGraph *g1 = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors[0],t1->GetV3()); 
	int n2 = t1->Draw("chi2:refl:err_chi2","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2(n,0);
    TGraph *g2 = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors2[0],t1->GetV3()); 
	int n3 = t1->Draw("chi2:refl:err_chi2","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors3(n,0);
    TGraph *g3 = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors3[0],t1->GetV3()); 

	// plot with hit times <220 ns in different locs
	int n1lowt = t1->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors1_lowt(n,0);
    TGraph *g1lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors1_lowt[0],t1->GetV3()); 
	int n2lowt = t1->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2_lowt(n,0);
    TGraph *g2lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors2_lowt[0],t1->GetV3()); 
	int n3lowt = t1->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors3_lowt(n,0);
    TGraph *g3lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors3_lowt[0],t1->GetV3()); 

	// plot with hit times >220 ns in different locs
	int n1hight = t1->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors1_hight(n,0);
    TGraph *g1hight = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors1_hight[0],t1->GetV3()); 
	int n2hight = t1->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2_hight(n,0);
    TGraph *g2hight = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors2_hight[0],t1->GetV3()); 
	int n3hight = t1->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
	float chi2high1[n];
	float chi2high1err[n];
	for (int i=0;i<n;i++){
		chi2high1[i]=t1->GetV1()[i];
		chi2high1err[i]=t1->GetV3()[i];
	}
	...
	// plot with all times in different locs
	int n1_2 = t2->Draw("chi2:refl:err_chi2","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors1_2(n,0);
    TGraph *g1_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors1_2[0],t2->GetV3()); 
	int n2_2 = t2->Draw("chi2:refl:err_chi2","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2_2(n,0);
    TGraph *g2_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors2_2[0],t2->GetV3()); 
	int n3_2 = t2->Draw("chi2:refl:err_chi2","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors3_2(n,0);
    TGraph *g3_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors3_2[0],t2->GetV3()); 

	// plot with hit times <220 ns in different locs
	int n1lowt_2 = t2->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors1lowt_2(n,0);
    TGraph *g1lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors1lowt_2[0],t2->GetV3()); 
	int n2lowt_2 = t2->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2lowt_2(n,0);
    TGraph *g2lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors2lowt_2[0],t2->GetV3()); 
	int n3lowt_2 = t2->Draw("chi2_lowt:refl:err_chi2_lowt","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors3lowt_2(n,0);
    TGraph *g3lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors3lowt_2[0],t2->GetV3()); 

	// plot with hit times >220 ns in different locs
	int n1hight_2 = t2->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==3 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors1hight_2(n,0);
    TGraph *g1hight_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors1hight_2[0],t2->GetV3()); 
	int n2hight_2 = t2->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
    vector <double> xerrors2hight_2(n,0);
    TGraph *g2hight_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors2hight_2[0],t2->GetV3()); 
	int n3hight_2 = t2->Draw("chi2_hight:refl:err_chi2_hight","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
	float chi2high2[n];
	float chi2high2err[n];
	for (int i=0;i<n;i++){
		chi2high2[i]=t2->GetV1()[i];
		chi2high2err[i]=t2->GetV3()[i];
	}
    vector <double> xerrors3hight_2(n,0);
    TGraph *g3hight_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors3hight_2[0],t2->GetV3()); 

	// compare the chi square with times >220 for the two collimators
	TCanvas *c1e = new TCanvas();
	TGraphErrors *tg1e = new TGraphErrors(n,chi2high1,chi2high2,chi2high1err,chi2high2err);
	tg1e->GetXaxis()->SetTitle("Chi square / ndof (times > 220 ns, top PMTs, 1.35)");
	tg1e->GetYaxis()->SetTitle("Chi square / ndof (times > 220 ns, top PMTs, 2.40)");
	tg1e->GetXaxis()->SetRangeUser(0,415);
	tg1e->GetYaxis()->SetRangeUser(0,415);
	tg1e->SetTitle("");
	tg1e->SetLineColor(kGreen+2);
	tg1e->Draw("ap");
	c1e->SaveAs("top_hight_col_comparison.png");
...
/*
	...
	leg->AddEntry(g1,"bottom, all times","lp");
	leg->AddEntry(g2,"barrel, all times","lp");
	leg->AddEntry(g3,"top, all times","lp");
	mg1->SetTitle("; Reflectivity; Chi square/ndof");
	mg1->Draw("a");
	leg->Draw();
	c1->SaveAs("col_1.35_refl.png");
	c1->SaveAs("col_1.35_refl.C");	
	...
	mg2->Draw("a");
	leg2->Draw();
	c2->SaveAs("col_1.35_refl_lowt.png");
	c2->SaveAs("col_1.35_refl_lowt.C");	
	...
	mg3->Draw("a");
	leg3->Draw();
	c3->SaveAs("col_1.35_refl_hight.png");
	c3->SaveAs("col_1.35_refl_hight.C");	
...
// now the graphs of the second collimator	
	...
	leg_2->AddEntry(g1_2,"bottom, all times","lp");
	leg_2->AddEntry(g2_2,"barrel, all times","lp");
	leg_2->AddEntry(g3_2,"top, all times","lp");
	mg1_2->SetTitle("; Reflectivity; Chi square/ndof");
	mg1_2->Draw("a");
	leg_2->Draw();
	c1_2->SaveAs("col_2.40_refl.png");
	c1_2->SaveAs("col_2.40_refl.C");	
	...
	mg2_2->Draw("a");
	leg2_2->Draw();
	c2_2->SaveAs("col_2.40_refl_lowt.png");
	c2_2->SaveAs("col_2.40_refl_lowt.C");	
	...
	mg3_2->Draw("a");
	leg3_2->Draw();
	c3_2->SaveAs("col_2.40_refl_hight.png");
	c3_2->SaveAs("col_2.40_refl_hight.C");	
*/
	// now a comparison of the one with the biggest difference
	n = t1->Draw("chi2:err_chi2","cylLoc==4 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
	double chisq_barrel[n];
	double chisq_barrel_err[n];
	for (int i =0;i<n;i++){
		chisq_barrel[i] = t1->GetV1()[i];
		chisq_barrel_err[i] = t1->GetV2()[i];
	}

	n = t1->Draw("chi2_lowt:err_chi2_lowt","cylLoc==5 && scat>0.749 && scat<0.7501 && abs>1.299 && abs<1.301","goff"); 
	double chisq_top[n];
	double chisq_top_err[n];
	for (int i =0;i<n;i++){
		chisq_top[i] = t1->GetV1()[i];
		chisq_top_err[i] = t1->GetV2()[i];
	}

	TCanvas *ce = new TCanvas();
	TGraphErrors *tge = new TGraphErrors(n,chisq_top,chisq_barrel,chisq_top_err,chisq_barrel_err);
	tge->GetXaxis()->SetTitle("Chi square / ndof (times > 220 ns, top PMTs)");
	tge->GetYaxis()->SetTitle("Chi square / ndof (all times, barrel PMTs)");
	tge->GetXaxis()->SetRangeUser(0,660);
	tge->SetTitle("");
	tge->SetLineColor(kGreen+2);
	tge->Draw("ap");
}
