...
void hitmap( const char *inFileName = "wcsim.root", bool verbosity = 0){ 
  ...
  TH2Poly *ODQpoly = new TH2Poly("ODQ","Charge in OD PMTs",-12000,12000,-12000,-3200);
  ...
  ODQpoly->GetZaxis()->SetRangeUser(50,3000);
  ODQpoly->GetYaxis()->SetRangeUser(-4000,-10000);
