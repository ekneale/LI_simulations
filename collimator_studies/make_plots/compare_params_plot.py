...
for line in open("colBottom/collim_1.35/results/scan_reduced_chi_sq_colBottom_allbarrelPMTs.txt","r"):
  print(line)
...
for line in open("colBottom/collim_2.00/results/scan_reduced_chi_sq_colBottom_allbarrelPMTs.txt","r"):
  vals = (line.strip().split(", "))
...
## Plot of scattering
plt.subplot(1,3,1)
plt.errorbar( rayff_val1, rayff_chi1, yerr=rayff_err1, label="1.35" ,linestyle='none',fmt='o',capsize=3,markersize=2)

plt.errorbar( rayff_val2, rayff_chi2, yerr=rayff_err2, label="2.00" ,linestyle='none',fmt='o',capsize=3,markersize=2)
plt.yscale("log")
#plt.show()
...
## Plot of absorption
plt.subplot(1,3,2)
plt.errorbar( absff_val1, absff_chi1, yerr=absff_err1, label="1.35", linestyle='none' ,fmt='o',capsize=3,markersize=2)

plt.errorbar( absff_val2, absff_chi2, yerr=absff_err2, label="2.00", linestyle='none' ,fmt='o',capsize=3,markersize=2)
plt.yscale("log")
#plt.show()
...
plt.subplot(1,3,3)
plt.errorbar( reflf_val1, reflf_chi1, yerr=reflf_err1, label="1.35" ,linestyle='none',fmt='o',capsize=3, markersize=2)
plt.yscale("log")

plt.errorbar( reflf_val2, reflf_chi2, yerr=reflf_err2, label="2.00" ,linestyle='none',fmt='o',capsize=3, markersize=2)
plt.yscale("log")
