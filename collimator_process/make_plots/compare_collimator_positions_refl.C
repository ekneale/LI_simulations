...
void compare_collimator_positions_refl(char const *filename, char const *filename2, char const *filename3){
    ...
    TTree *t3 = (TTree*)f3->Get("chisquareT");
...
*/
	// third collimator position
	// plot with all times in different locs
	int n1_3 = t3->Draw("chi2:refl:err_chi2/4.","cylLoc==3 && scat>0.749 && scat<0.7501&& abs>1.299 && abs<1.301 && chi2<2000 && refl>0.7","goff"); 
    vector <double> xerrors1_3(n1_3,0);
    TGraph *g1_3 = new TGraphErrors(n1_3,t3->GetV2(),t3->GetV1(),&xerrors1_3[0],t3->GetV3()); 
	int n2_3 = t3->Draw("chi2:refl:err_chi2/4.","cylLoc==4 && scat>0.749 && scat<0.7501&& abs>1.299 && abs<1.301 && chi2<2000 && refl>0.7","goff"); 
    vector <double> xerrors2_3(n2_3,0);
    TGraph *g2_3 = new TGraphErrors(n2_3,t3->GetV2(),t3->GetV1(),&xerrors2_3[0],t3->GetV3()); 
	int n3_3 = t3->Draw("chi2:refl:err_chi2/4.","cylLoc==5 && scat>0.749 && scat<0.7501&& abs>1.299 && abs<1.301 && chi2<2000 && refl>0.7","goff"); 
    vector <double> xerrors3_3(n3_3,0);
    TGraph *g3_3 = new TGraphErrors(n3_3,t3->GetV2(),t3->GetV1(),&xerrors3_3[0],t3->GetV3()); 
...
*/
	...
	g1_3->SetLineColor(kBlue+2);
    g2_3->SetLineColor(kRed+2);
    g3_3->SetLineColor(kGreen+2);
/*
	g1lowt_3->SetLineColor(kBlue+2);
    g2lowt_3->SetLineColor(kRed+2);
    g3lowt_3->SetLineColor(kGreen+2);
	g1hight_3->SetLineColor(kBlue+2);
    g2hight_3->SetLineColor(kRed+2);
    g3hight_3->SetLineColor(kGreen+2);
*/
	g1_3->SetMarkerColor(kBlue+2);
    g2_3->SetMarkerColor(kRed+2);
    g3_3->SetMarkerColor(kGreen+2);
/*
	g1lowt_3->SetMarkerColor(kBlue+2);
    g2lowt_3->SetMarkerColor(kRed+2);
    g3lowt_3->SetMarkerColor(kGreen+2);
	g1hight_3->SetMarkerColor(kBlue+2);
    g2hight_3->SetMarkerColor(kRed+2);
    g3hight_3->SetMarkerColor(kGreen+2);
*/
	g1_3->SetMarkerStyle(7);
    g2_3->SetMarkerStyle(7);
    g3_3->SetMarkerStyle(7);
/*
	g1lowt_3->SetMarkerStyle(7);
    g2lowt_3->SetMarkerStyle(7);
    g3lowt_3->SetMarkerStyle(7);
	g1hight_3->SetMarkerStyle(7);
    g2hight_3->SetMarkerStyle(7);
    g3hight_3->SetMarkerStyle(7);
*/
	g1_3->SetMarkerSize(3);
    g2_3->SetMarkerSize(3);
    g3_3->SetMarkerSize(3);
/*
	g1lowt_3->SetMarkerSize(3);
    g2lowt_3->SetMarkerSize(3);
    g3lowt_3->SetMarkerSize(3);
	g1hight_3->SetMarkerSize(3);
    g2hight_3->SetMarkerSize(3);
    g3hight_3->SetMarkerSize(3);
*/
	...
	mg1->Draw("a");
	leg->Draw();
	c1->SaveAs("collimator_newgen_refl.png");
	c1->SaveAs("collimator_newgen_refl.C");	
/*	
...
// now the graphs of the second collimator	
	...
	mg1_2->Draw("a");
	leg_2->Draw();
	c1_2->SaveAs("collimator_oldgen_refl.png");
	c1_2->SaveAs("collimator_oldgen_refl.C");	
...
*/
	...
	g2_3->SetLineColor(kBlack);
	g2_3->SetMarkerColor(kBlack);
	mg2->Add(g2_2,"p");
	mg2->Add(g2_3,"p");
	TLegend *leg2 = new TLegend(0.55,0.65,0.88,0.85);
	leg2->AddEntry(g2,"barrel, near PMTs","lp");
	leg2->AddEntry(g2_2,"barrel, centre","lp");
	leg2->AddEntry(g2_3,"barrel, near wall","lp");
	mg2->SetTitle("; Reflectivity; Chi square/ndof");
	mg2->Draw("a");
	leg2->Draw();
	c2->SaveAs("collimator_compare_positions_refl.png");
	c2->SaveAs("collimator_compare_positions_refl.C");	
