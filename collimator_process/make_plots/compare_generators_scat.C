...
void compare_generators_scat(char const *filename, char const *filename2){
	...
	int n1 = t1->Draw("chi2:scat:err_chi2/4.","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector<double> xerrors(n1,0);
    TGraph *g1 = new TGraphErrors(n1,t1->GetV2(),t1->GetV1(),&xerrors[0],t1->GetV3()); 
	int n1_2 = t2->Draw("chi2:scat:err_chi2/4.","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors1_2(n1_2,0);
    TGraph *g1_2 = new TGraphErrors(n1_2,t2->GetV2(),t2->GetV1(),&xerrors1_2[0],t1->GetV3()); 
	
    int n2 = t1->Draw("chi2:scat:err_chi2/4.","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2(n2,0);
    TGraph *g2 = new TGraphErrors(n2,t1->GetV2(),t1->GetV1(),&xerrors2[0],t1->GetV3()); 
	int n2_2 = t2->Draw("chi2:scat:err_chi2/4.","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2_2(n2_2,0);
    TGraph *g2_2 = new TGraphErrors(n2_2,t2->GetV2(),t2->GetV1(),&xerrors2_2[0],t1->GetV3()); 
	
    int n3 = t1->Draw("chi2:scat:err_chi2/4.","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors3(n3,0);
    TGraph *g3 = new TGraphErrors(n3,t1->GetV2(),t1->GetV1(),&xerrors3[0],t1->GetV3()); 
	int n3_2 = t2->Draw("chi2:scat:err_chi2/4.","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors3_2(n3_2,0);
    TGraph *g3_2 = new TGraphErrors(n3_2,t2->GetV2(),t2->GetV1(),&xerrors3_2[0],t1->GetV3()); 
	...
	/*
	int n1lowt = t1->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors1_lowt(n,0);
    TGraph *g1lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors1_lowt[0],t1->GetV3()); 
	int n2lowt = t1->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2_lowt(n,0);
    TGraph *g2lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors2_lowt[0],t1->GetV3()); 
	int n3lowt = t1->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors3_lowt(n,0);
    TGraph *g3lowt = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors3_lowt[0],t1->GetV3()); 

	// plot with hit times >220 ns in different locs
	int n1hight = t1->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors1_hight(n,0);
    TGraph *g1hight = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors1_hight[0],t1->GetV3()); 
	int n2hight = t1->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2_hight(n,0);
    TGraph *g2hight = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors2_hight[0],t1->GetV3()); 
	int n3hight = t1->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors3_hight(n,0);
    TGraph *g3hight = new TGraphErrors(n,t1->GetV2(),t1->GetV1(),&xerrors3_hight[0],t1->GetV3()); 
	*/

/*	// plot with hit times <220 ns in different locs
	int n1lowt_2 = t2->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors1lowt_2(n,0);
    TGraph *g1lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors1lowt_2[0],t2->GetV3()); 
	int n2lowt_2 = t2->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2lowt_2(n,0);
    TGraph *g2lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors2lowt_2[0],t2->GetV3()); 
	int n3lowt_2 = t2->Draw("chi2_lowt:scat:err_chi2/4._lowt","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors3lowt_2(n,0);
    TGraph *g3lowt_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors3lowt_2[0],t2->GetV3()); 

	// plot with hit times >220 ns in different locs
	int n1hight_2 = t2->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==3 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors1hight_2(n,0);
    TGraph *g1hight_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors1hight_2[0],t2->GetV3()); 
	int n2hight_2 = t2->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==4 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
    vector <double> xerrors2hight_2(n,0);
    TGraph *g2hight_2 = new TGraphErrors(n,t2->GetV2(),t2->GetV1(),&xerrors2hight_2[0],t2->GetV3()); 
	int n3hight_2 = t2->Draw("chi2_hight:scat:err_chi2/4._hight","cylLoc==5 && refl>0.899 && refl<0.901 && abs>1.299 && abs<1.301 && scat>0.5 && chi2<1000 && chi2>0","goff"); 
...
*/
	...
	mg1->Draw("a");
	leg->Draw();
	c1->SaveAs("collimator_newgen_scat.png");
	c1->SaveAs("collimator_newgen_scat.C");	
/*	
...
// now the graphs of the second collimator	
	...
	mg1_2->Draw("a");
	leg_2->Draw();
	c1_2->SaveAs("collimator_oldgen_scat.png");
	c1_2->SaveAs("collimator_oldgen_scat.C");	
...
*/
	...
	mg2->Add(g2_2,"p");
	TLegend *leg2 = new TLegend(0.55,0.65,0.88,0.85);
	leg2->AddEntry(g2,"PMT ID","lp");
	leg2->AddEntry(g2_2,"Distance from collimator","lp");
	mg2->SetTitle("; Scattering; Chi square/ndof");
	mg2->Draw("a");
	leg2->Draw();
	c2->SaveAs("collimator_compare_gen_scat.png");
	c2->SaveAs("collimator_compare_gen_scat.C");	
