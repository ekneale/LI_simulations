...
//=========  (Tue Sep 26 19:22:04 2023) by ROOT version 6.20/04
   TCanvas *c1 = new TCanvas("c1", "c1",10,47,700,500);
   c1->Range(0.4851562,1.329322,1.052344,23.16749);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(4.007649);
   Graph_Graph1001->SetMaximum(7.60291);
   ...
   TH1F *Graph_Graph1002 = new TH1F("Graph_Graph1002","Graph",100,0.60375,1.00875);
   Graph_Graph1002->SetMinimum(4.181818);
   Graph_Graph1002->SetMaximum(21.64481);
   ...
   Graph_Graph1003->SetMinimum(4.505523);
   Graph_Graph1003->SetMaximum(9.590541);
