...
BASE_DATA_DIR=/data2/kneale/hk-software/spe_sims # wherever you want to save your OD work
if [ ! -e $BASE_DATA_DIR ]; then mkdir $BASE_DATA_DIR; fi

SETUP_DIR=$BASE_DATA_DIR/../LI_simulations/spe_simulations # where the git repo is
...
cp $SETUP_DIR/$original_macro $DATA_DIR/macro_diffuser_1_0.9_0.75_1.30.mac
...
root -l -x -b -q 'sample-root-scripts/read_LIGen_diffuser_pulses.C("/scratch/kneale/diffuser_1_0.9_0.75_1.30.root","/scratch/kneale/reduced_diffuser_1_0.9_0.75_1.30.root")'
