...
//=========  (Tue Oct 10 13:31:09 2023) by ROOT version 6.20/04
   ...
   Graph_Graph_Graph10021007->SetMaximum(1.559671);
   ...
   TLegendEntry *entry=leg->AddEntry("Graph","barrel, near PMTs","lp");
   ...
   entry=leg->AddEntry("Graph","barrel, near wall","lp");
