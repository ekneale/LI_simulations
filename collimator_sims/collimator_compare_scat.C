void collimator_compare_scat()
{
//=========Macro generated from canvas: c1_n3/c1_n3
//=========  (Tue Oct 10 14:45:17 2023) by ROOT version 6.20/04
   TCanvas *c1_n3 = new TCanvas("c1_n3", "c1_n3",10,47,700,500);
   c1_n3->Range(0.4851562,-2.477022,1.052344,22.2932);
   ...
   Graph_Graph_Graph10021007->SetMinimum(0.6644567);
   Graph_Graph_Graph10021007->SetMaximum(19.93628);
   ...
   Graph_Graph_Graph10051008->SetMinimum(0.6957565);
   Graph_Graph_Graph10051008->SetMaximum(20.72117);
