...
*/
	...
	mg1->Draw("a");
	leg->Draw();
	c1->SaveAs("collimator_abs.png");
	c1->SaveAs("collimator_abs.C");	
/*	
...
// now the graphs of the second collimator	
	...
	mg1_2->Draw("a");
	leg_2->Draw();
	c1_2->SaveAs("collimator_abs.png");
	c1_2->SaveAs("collimator_abs.C");	
...
*/
	...
	mg2->Draw("a");
	leg2->Draw();
	c2->SaveAs("collimator_compare_abs.png");
	c2->SaveAs("collimator_compare_abs.C");	
