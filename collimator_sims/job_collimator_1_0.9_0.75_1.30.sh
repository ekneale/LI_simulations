...
root -l -x -b -q 'sample-root-scripts/read_LIGen_OD_output.C("/scratch/$USER/collimator_1_0.9_0.75_1.30.root","/scratch/$USER/reduced_collimator_1_0.9_0.75_1.30.root")'
